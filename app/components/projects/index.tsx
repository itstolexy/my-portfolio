    ...
    <div className="pt-10">
      <div className="text-tola-white md:mx-32 mx-5 py-10 md:py-20">
        ...
        >
          ...
          <ProjectCard
            imgSrc="/images/oba.png"
            altText="ObaHills Hub Project"
            liveLink="http://oba-hills.vercel.app/"
            githubLink="https://github.com/itstolexy/oba-hills"
            description="ObaHills Hub is a modern ecommerce platform offering a seamless online shopping experience. The platform features a comprehensive product catalog, secure shopping cart, user authentication, order management, and integrated payment processing. Built with cutting-edge web technologies, it provides customers with an intuitive interface for browsing products, managing their purchases, and completing transactions efficiently. (Private repository - available upon request)"
          />
          ...
          <ProjectCard
            ...
            description="Vira is a comprehensive equipment rental platform that streamlines the process of hiring tools and gear for various needs. The platform features an extensive catalog of equipment, advanced search and filtering capabilities, real-time availability tracking, flexible rental periods, and secure payment processing. Built with modern web technologies, Vira provides users with an intuitive booking system, detailed product information, and seamless transaction management to ensure you get the equipment you need efficiently and conveniently."
          />
          <ProjectCard
